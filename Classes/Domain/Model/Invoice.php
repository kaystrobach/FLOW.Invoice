...
use KayStrobach\Invoice\Service\StornoInvoiceService;
...
class Invoice
{
    ...
    public function createDocument(ControllerContext $controllerContext = null, bool $hideSinglePrice = false)
    {
        ...
        $this->completeElectronicInvoiceService->addRenderedPdfToInvoice($this);
    }
     ...
     * @Flow\Inject
     */
    protected StornoInvoiceService $stornoInvoiceService;
     ...
     * @return ?Invoice
     */
    public function makeCancellationInvoice(ControllerContext $controllerContext = null, \Closure $callback = null, bool $keepChangeable = false): ?Invoice
    {
        ...
        return $this->stornoInvoiceService->makeStornoInvoice(
            $this,
            $controllerContext,
            $callback,
            $keepChangeable
    ...
    public function makePartialClone(): Invoice
    {
        ...
        $clone->setOrder(clone $this->getOrder());
        $clone->setOfferNumber($this->getOfferNumber());
        $clone->setPaymentTermText($this->getPaymentTermText());
